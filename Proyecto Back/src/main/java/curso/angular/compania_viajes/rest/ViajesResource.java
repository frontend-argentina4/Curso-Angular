...
public class ViajesResource {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ViajesDTO> getViajes(@PathVariable final Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Void> updateViajes(@PathVariable final Long id,
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteViajes(@PathVariable final Long id) {
